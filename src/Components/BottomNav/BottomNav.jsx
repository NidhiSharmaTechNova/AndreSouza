...
export default function BottomNav() {
  ...
  const handleClick = (path) => {
    setTooltipId(""); // <- Tooltip hide on click
    navigate(path);
  };
  ...
  <button className="extra-icon">
    ...
    //     <button
    //       key={tab.id}
          // className={`nav-item ${location.pathname === tab.path ? "active" : "hover-bg"}`}
...
//   { id: "craft", label: "Craft", path: "/craft", icon: <CraftIcon /> },
//   { id: "notes", label: "Notes", path: "/notes", icon: <NotesIcon /> },
//   { id: "camera", label: "Camera", path: "/camera", icon: <CameraIcon /> },
// ];
...
//       <button className="extra-icon" data-tooltip="Sound">
//         <VolumeUpIcon />
//       </button>
//     </div>
//   );
...
// const tabs = [
//   { id: "home", label: "Home", path: "/", icon: <HomeIcon /> },
//   { id: "projects", label: "Project", path: "/projects", icon: <SearchIcon /> },
//   { id: "craft", label: "Craft", path: "/craft", icon: <FavoriteIcon /> },
//   { id: "notes", label: "Notes", path: "/notes", icon: <PersonIcon /> },
// ]
